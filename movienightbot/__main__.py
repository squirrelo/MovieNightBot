...
arguments.add_argument("-c", "--configfile", type=str, required=True, help="Path to the config file")
arguments.add_argument("-l", "--loglevel", default="INFO", required=False, help="Logging level")
